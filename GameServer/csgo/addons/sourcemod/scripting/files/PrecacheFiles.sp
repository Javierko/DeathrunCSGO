public void AddFilesToDownloadList()
{
  ...
  AddFileToDownloadsTable("materials/overlays/deathrun/jokervyhral.vmt");
  AddFileToDownloadsTable("materials/overlays/deathrun/jokervyhral.vtf");
...
{
  PrecacheDecal("overlays/deathrun/jokervyhral.vtf", true);
  PrecacheDecal("overlays/deathrun/jokervyhral.vmt", true);
