	...
	if(IsValidClient(client))
	{
		if(GetClientTeam(client) == CS_TEAM_CT)
		{
			if(b_ClientRespawn[client])
			{
				...
				if(timeleft > 0.01)
				{
					PrintHintText(client, "<font color='#f29f00'>You will be respawned in: </font><font color='#00ff00'>%0.01f</font> \n <font color='#f29f00'>Remaining lives: %d</font>", timeleft, i_ClientLifes[client]);
				}
